...
class Session:
    ...
    def __init__(self, session_id, client_session_id, steam_login, steam_login_secure):
    ...
    @property
    def client_session_id(self): return self._client_session_id

    @property
    def steam_login(self): return self._steam_login

    @property
    def steam_login_secure(self): return self._steam_login_secure
